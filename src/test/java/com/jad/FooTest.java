...
class FooTest {
    ...
    void barsAttributeTest() {
        Utils.testIfPrivateAttributeExistsWithGenericType("com.jad.IBar", "bars", FooTest.fooClass);
    }
    ...
    void singleConstructorWithIBazParameterTest() {
        ...
        if (barsValue != null) {
            assertTrue(iBarClass.isAssignableFrom(((List<?>) barsValue).getFirst().getClass()),
                       "The bars field should contain elements of type IBar.");
        }
